...
if (!class_exists('WC_Cielo')) :
    ...
    if (empty(get_option('woocommerce_cielo_general_settings_settings'))) {
        //Cubeat
        $default_options = array(
            'api_version' => 'version_3_0',
            'admin_sale_capture' => 'no',
            'time_sale_capture' => 5);
        update_option('woocommerce_cielo_general_settings_settings', $default_options);
    }
